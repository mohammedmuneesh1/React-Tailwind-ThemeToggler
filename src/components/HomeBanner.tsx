...
const HomeBanner = ()=>{
    ...
    const {increment,theme,toggleTheme} = useContext(ApplicationContext);
  ...
  // alert("hello world ")
    ...
    return(
        <section className="max-w-screen-2xl mx-auto  min-h-screen bg-blue-400">
         
<div className="min-h-screen flex flex-1 w-full flex-col items-center justify-center text-center px-4 py-20 bg-gradient-to-r from-green-50/50 via-teal-50 to-green-50/50 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800">
      <a
        href="#"
